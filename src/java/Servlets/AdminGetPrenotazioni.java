...
public class AdminGetPrenotazioni extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        // se una request è "" devo metterli a null
        ...
        String email=request.getParameter("titolo");
        String ruolo=request.getParameter("ruolo");
        //Timestamp prenotazioneDa=request.getParameter("ruolo");
        //Timestamp  prenotazioneA=request.getParameter("ruolo");
        String tipoPrezzo=request.getParameter("tipoPrezzo"); // intero, disabile
