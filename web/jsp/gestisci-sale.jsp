                        ...
                        <div class="row">
                            <c:forEach var="i"  begin="0" end="${tmp.getSize()-1}">
                                ...
                                <button <c:choose>
                                    ...
                                    </c:choose> data-toggle="tooltip" data-placement="top"><div class="hidden-xs"><c:out value="${fn:toUpperCase(tmp.getRiga())}"></c:out><c:if test="${tmp.getColonna(i) < 10}">0</c:if><c:out value="${tmp.getColonna(i)}"></c:out></div></button>
                            </c:forEach>
                        </div>
                    </c:forEach>
                    </div>
