                ...
                <form id="paga-form" action="conferma-prenotazione.html">
                    <div class="modal-body">
                        ...
                        <div id="form-carta" style="display:none;">
                            <div class="row">
                                <div class="col-md-6"><input type="text" class="form-control req" placeholder="Nome"></div>
                                <div class="col-md-6"><input type="text" class="form-control req" placeholder="Cognome"></div>
                            </div>
                            <div class="row" style="margin-top: 8px;">
                                <div class="col-md-6"><input type="text" class="form-control req" placeholder="Numero di Carta di Credito"></div>
                                <div class="col-md-4"><input type="text" class="form-control req" placeholder="Scadenza"></div>
                                <div class="col-md-2"><input type="text" class="form-control req" placeholder="CCV"></div>
                            </div>
                        </div>
                    </div>
                    <div class="modal-footer">
