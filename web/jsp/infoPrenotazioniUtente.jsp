    ...
    <div class="container">
        ...
        <table class="table table-bordered table-striped">
            ...
            <c:forEach var="tmp" items="${requestScope.infoPrenotazioniUtente}">
                ...
                <tr>
                    <td><a class="no-color" href="dettaglio-film.html?idfilm=<c:out value="${tmpFilm.idFilm}"></c:out>"><c:out value="${tmpFilm.titolo}"></c:out></a> <small class="text-muted"><c:out value="${tmpFilm.regista}"></c:out> &middot; <c:out value="${tmpFilm.anno}"></c:out> &middot; <c:out value="${tmpFilm.durata}"></c:out>min</small></td>
