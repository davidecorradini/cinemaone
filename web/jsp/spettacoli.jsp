    ...
    <div class="container">
        ...
        <div class="table-responsive">
            ...
            <c:forEach var="tmp" items="${requestScope.spettacoli}">
                ...
                <tr>
                    <td><a class="no-color" href="dettaglio-film.html?idfilm=<c:out value="${tmpFilm.idFilm}"></c:out>"><c:out value="${tmpFilm.titolo}"></c:out></a> <small class="text-muted hidden-xs"><c:out value="${tmpFilm.regista}"></c:out> &middot; <c:out value="${tmpFilm.anno}"></c:out> &middot; <c:out value="${tmpGenere.descrizione}"></c:out> &middot; <c:out value="${tmpFilm.durata}"></c:out>min</small></td>
